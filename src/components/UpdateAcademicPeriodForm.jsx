...
import "./styles/UpdateAcademicPeriod.css"
            ...
            <div class="modal">
                <div class="modal__container">
                    <div class="modal__featured">
                        ...
                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/57/Logo_de_la_Universidad_del_Cauca.svg/2048px-Logo_de_la_Universidad_del_Cauca.svg.png" class="modal__product" />
                    </div>
                    <div class="modal__content">
                        <h2>Editar Periodo Academico</h2>
                                ...
                                <li class="form-list__row form-list__row--inline">
                                    <div>
                                        ...
                                        <div class="form-list__input-inline">
                                            <input type="text" name="cc_month" placeholder="DD/MM/YYYY" pattern="\\d*" minlength="2" maxlength="2" required="" />
                                            <input type="text" name="cc_year" placeholder="DD/MM/YYYY" pattern="\\d*" minlength="2" maxlength="2" required="" />
                                        </div>
                                    </div>
                                </li>
                                <li>
