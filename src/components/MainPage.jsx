...
function MainPage() {
    return (
        <>
            <main>
                ...
                <div class="achievements">
                    <div class="work">
                        ...
                        <p class="work-heading">Gestión de labor</p>
                        <p class="work-text">Permite al coordinador gestionar las tareas docentes. Esto incluye crear, editar, consultar y desactivar tareas. Cada tarea tiene un nombre, está vinculada a un tipo de labor y se le asigna una cantidad de horas</p>
                    </div>
                    <div class="work">
                        <i class="fas fa-user-clock"></i>
                        <p class="work-heading">Gestión períodos académicos</p>
                        <p class="work-text">Define un periodo académico como el tiempo en que estará activa la labor
                        académica, tiene una un nombre o descripción, año (2023) y semestre (toma valor 1 o 2) , fecha inicio y fecha
                        final.</p>
                    </div>
                    <div class="work">
                        <i class="fas fa-graduation-cap"></i>
                        <p class="work-heading">Gestión de autoevaluación</p>
                        <p class="work-text"> Esto involucra la asignación de períodos académicos, docentes y la creación de ítems de evaluación que contienen detalles esenciales, como el nombre de la labor o actividad, el tipo de labor, las horas dedicadas, 
            ...
            <footer class="footer">
                <div class="copy">&copy; 2023 Universidad del Cauca</div>
